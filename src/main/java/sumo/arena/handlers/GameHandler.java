...
import sumo.events.ArenaStartEvent;
import sumo.events.ArenaTimeoutEvent;
import sumo.events.PlayerWinArenaEvent;
...
public class GameHandler {
	...
	public GameHandler(Sumo plugin, Arena arena) {
		this.plugin = plugin;
		this.arena = arena;
