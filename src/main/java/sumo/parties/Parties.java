...
public class Parties {
	...
	/**
	 * Create a Sumo party. The player creating the party is automatically the party leader.
	 *
	...
	/**
	 * Leave the Sumo party. If the party leader leaves, the party is automatically disbanded.
	 *
