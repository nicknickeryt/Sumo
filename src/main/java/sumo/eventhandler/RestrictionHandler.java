...
public class RestrictionHandler implements Listener {
	...
	public RestrictionHandler(Sumo plugin) {
		this.plugin = plugin;
	}

	private HashSet<String> allowedcommands = new HashSet<>(
		Arrays.asList("/sumo leave", "/sumo vote", "/sp leave", "/sp vote", "/sp help", "/sp info", "/sp stats", "/sumo stats", "/sp", "/sumo"));
	...
	public void onPlayerCommand(PlayerCommandPreprocessEvent e) {
		...
		if (player.hasPermission("sumo.cmdblockbypass")) {
			return;
		}
