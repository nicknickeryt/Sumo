...
public class Bars {
	...
	private static BarColor getBarColor() {
		int index = 0;
		String col = Sumo.getInstance().getConfig().getString("special.BossBarColor");
	...
	public static void setBar(Arena arena, String message, int count, int seconds, double progress, Sumo plugin) {
	...
	public static void loadBars(Sumo plugin) {
