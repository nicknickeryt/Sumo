...
public class ShopFiles {
	...
	public void setShopItems() {
		...
		cfg.addDefault("1.permission", "sumo.shop.1");
		...
		cfg.addDefault("2.permission", "sumo.shop.2");
		...
		cfg.addDefault("3.permission", "sumo.shop.3");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("4.permission", "sumo.shop.4");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("5.permission", "sumo.shop.5");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("6.permission", "sumo.shop.6");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("7.permission", "sumo.shop.7");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("8.permission", "sumo.shop.8");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("9.permission", "sumo.shop.9");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("10.permission", "sumo.shop.10");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("11.permission", "sumo.shop.11");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("12.permission", "sumo.shop.12");
		lore = new ArrayList<String>();
		...
		*/
		...
		cfg.addDefault("13.permission", "sumo.shop.13");
		lore = new ArrayList<String>();
