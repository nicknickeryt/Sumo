...
public class TitleMsg {
	...
	public static String join = "&7[&6Sumo&7]";
	...
	public static String starting = "&7[&6Sumo&7]";
	public static String substarting = "&7Starting in &6{COUNT}";
	public static String start = "&7[&6Sumo&7]";
	public static String substart = "&7The Game has started";
	public static String leave = "";
	public static String subleave = "";

	public static void sendFullTitle(Player player, String title, String subtitle, int fadeIn, int stay, int fadeOut, Sumo plugin) {
	...
	public static void loadTitles(Sumo plugin) {
