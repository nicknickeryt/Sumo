...
public class SumoConversation implements ConversationAbandonedListener {
    ...
    public SumoConversation(Sumo plugin, Player player, Arena arena, ConversationType conversationType){
        this.player = player;
        this.plugin = plugin;
        this.arena = arena;
    ...
    private Prompt getEntryPrompt(ConversationType type, Player player) {
        ...
        switch (type){
            ...
            default:
                player.sendMessage(GRAY + "[" + GOLD + "Sumo" + GRAY + "]" + RED + " Unexpected conversation type: " + type);
                return null;
        }
    }
    ...
    public void conversationAbandoned(ConversationAbandonedEvent event) {
        if (!event.gracefulExit())
            event.getContext().getForWhom().sendRawMessage(GRAY + "[" + GOLD + "Sumo" + GRAY + "]" + RED + "Conversation aborted...");
    }

    public static void sendErrorMessage(ConversationContext context, String message) {
        context.getForWhom().sendRawMessage(GRAY + "[" + GOLD + "Sumo" + GRAY + "] " + RED + message + ". Please try again...");
    }
