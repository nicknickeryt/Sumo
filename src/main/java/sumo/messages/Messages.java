...
public class Messages {
	...
	public static String spprefix = "&7[&6Sumo_reloaded&7]";
	public static String menutitle = "&1Sumo_reloaded Arenas";
	...
	public static String menutracker = "&1Sumo player tracker";
	...
	public static String playerjoininvite = "&c{RANK}&6{COLOR}{PLAYER} &7has joined Sumo arena &6{ARENA}&7, click to play";
	...
	public static String playernotinarena = "&c You are not in a Sumo arena";
	...
	public static String statshead = "&7=========[&6Sumo Stats&7]=========";
	public static String rewardshead = "&7======[&6Sumo Rewards&7 - &a{ARENA}&7]======";
	public static String leaderhead = "&7======[&6Sumo Leaderboard&7]======";
	public static String resultshead = "&7============[&6Sumo&7]============";
	...
	public static String shopmoneyheader = "&fSumo Shop Account";
	...
	public static String helpcmds = "View all Sumo commands";
	public static String helpinfo = "View plugin info";
	public static String helpstats = "View player stats";
	public static String helplb = "Display the Sumo leaderboard";
	...
	public static String setupaddkit = "Create a Sumo kit";
	public static String setupdelkit = "Delete a Sumo kit";
	...
	public static String setupresetstats = "Remove all Sumo stats for the player";
	public static String setupresetrank = "Remove player's rank from the cache";
	public static String setupwaiting = "Set a spawn location used prior to joining the arena";
	public static String setupdelwaiting = "Delete the waiting spawn location";
	...
	public static String partynotenabled = "&c Sumo parties are not currently enabled";
	...
	public static void loadMessages(Sumo plugin) {
		...
		setupwaiting = config.getString("setupwaiting", setupwaiting);
		setupdelwaiting = config.getString("setupdelwaiting", setupdelwaiting);
	...
	private static void saveMessages(File messageconfig) {
		...
		config.set("setupwaiting", setupwaiting);
		config.set("setupdelwaiting", setupdelwaiting);
